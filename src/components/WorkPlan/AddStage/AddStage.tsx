...
const AddStage: React.FC<AddStageProps> = ({ patientId, workPlanId, updateList }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            setLoading(true)
            const addStage = values.stage
            try {
                const res = await axiosWithToken.put(`${SERVER_URL}/api/workPlan/createStage?patientId=${patientId}&id=${workPlanId}`, addStage,
                    {
                        headers: {
